            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="sugerencia.fecha.label" default="Fecha" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${sugerenciaInstance?.fecha}" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="sugerencia.nombreDeReportador.label" default="Nombre De Reportador" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: sugerenciaInstance, field: "nombreDeReportador")}</td>
