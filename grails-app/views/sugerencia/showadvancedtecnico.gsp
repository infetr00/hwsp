...
<div class="nav">
  ...
  <span class="menuButton"><g:link class="listtecnico" controller="incidencia" action="list">Lista de Incidencias</g:link></span>
  <span class="menuButton"><g:link class="listtecnico" action="list">Lista de Sugerencias</g:link></span>
